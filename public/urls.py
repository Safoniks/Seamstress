...
urlpatterns = format_suffix_patterns([
    ...
    url(r'^worker/start-working/$', views.PublicWorkerDetail.as_view(), name='start-working'),
    url(r'^worker/stop-working/$', views.PublicWorkerDetail.as_view(), name='stop-working'),
])
